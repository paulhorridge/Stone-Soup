...
elint{1}.sensor.H = [1 0 0 0; 0 0 1 0];
...
elint{2}.sensor.H = [1 0 0 0; 0 0 1 0];
...
for j = 1:numel(elint)
    for t = 1:ntargets
        ...
        elint{j}.meas.targetNum = [elint{j}.meas.targetNum; repmat(t, nthesemeas, 1)];
...
for t = 1:ntargets
    ...
    ais.meas.targetNum = [ais.meas.targetNum; repmat(t, nthesemeas, 1)];
end
...
smaj = sample_lognormal(smaj_mean, smaj_std, nmeas)';%repmat(1000,nmeas,1);%
smin = sample_lognormal(smin_mean, smin_std, nmeas)';%repmat(1000,nmeas,1);%
